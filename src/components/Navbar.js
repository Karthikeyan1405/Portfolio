    ...
    <div>
        <nav className='fixed w-full z-20 top-0 bg-orange-100 bg-opacity-80'>
            <div className='max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2'>
                <img src={logo} className='h-8 ml-4' alt="KN BRAND"/>
            
            <div className='flex md:order-2'>
                <button onClick={toggle} className='inline-flex p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden focus:ring-2 focus:ring-gray-200'><AiOutlineMenuFold className='text-orange-400 text-lg'/></button>
        ...
        <Link spy={true} to='Project'>
                <li>
                    <div className='block py-2 pl-3 pr-4 rounded md:p-0 hover:text-orange-600 text-violet-700'>Project</div>
                </li>
       </Link>
